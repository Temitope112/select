  ...
  return (
    <footer className="bg-black text-white">
        ...
        <div className="mx-auto max-w-7xl px-6 py-20 lg:px-8 lg:py-24">
          <div className="flex flex-col gap-8 md:flex-row md:items-end md:justify-between">
            ...
            <motion.a
              ...
              className="group inline-flex w-fit items-center gap-3 rounded-full bg-amber-500 px-6 py-4 text-sm font-bold text-black transition-all duration-300 hover:bg-amber-400"
            >
      ...
      <div className="mx-auto max-w-7xl px-6 py-16 lg:px-8 lg:py-20">
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-[1.4fr_0.7fr_0.9fr]">
          {/* Brand */}
          <div>
            ...
            <p className="mt-7 max-w-sm text-sm leading-7 text-neutral-500">
              Premium grooming, precision styling and
              personal care for the modern gentleman.
            </p>
        ...
        {/* Bottom */}
        <div className="mt-16 flex flex-col gap-4 border-t border-white/10 pt-6 text-xs text-neutral-600 sm:flex-row sm:items-center sm:justify-between">
          <p>
            © {new Date().getFullYear()} Select Place Barber &
